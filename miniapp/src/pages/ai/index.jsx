...
export default function AiAssistant() {
  ...
  return (
    <View className='ai-page'>
      <View className='ai-hero'><View><Text className='eyebrow'>SYSTEM AI</Text><Text className='page-title'>租房问题，直接问</Text><Text className='page-copy'>围绕当前租房阶段给出能执行的证据清单、沟通话术和下一步。</Text></View><Text className='local-badge'>仅本地分析</Text></View>
