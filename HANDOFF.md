...
- 完成合同综合审查：用户单独授权后，本地规则先在后台生成风险线索，AI 再结合双重脱敏合同文字、线索和服务端知识库核验补漏，逐字证据校验后一次性展示合并报告；拒绝授权或 AI 失败时回退本地结果。
...
3. 微信公众平台后台的隐私保护指引需增加“AI 合同全文复核”用途，披露脱敏合同文字会发送至租小审服务端和模型服务商。
...
3. 在微信公众平台后台隐私保护指引增加“AI 合同全文复核”，说明单独授权、双重脱敏、模型服务商处理范围，以及照片和附件原文件不发送。
...
- 合同页混合审查先在本地运行规则；单独授权后，合同文字经本机和服务端双重脱敏、服务端分段，再交给模型全文复核。
