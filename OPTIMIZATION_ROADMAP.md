...
> ⚠️ 本文档为 2026-06-24 的历史快照，记录的是重构前（`App.jsx` 1911 行、无测试、无文件上传、无 AI 集成）的优化计划。
> 文中 P0-P3 任务大多已完成：组件已拆分、文件上传（TXT/MD/DOCX/PDF/OCR）已实现、DOCX/PDF 导出已上线、AI 集成已接入主流程、测试已覆盖 E2E/RAG/小程序可靠性等。
> 如需了解当前真实状态，请参阅 `HANDOFF.md` 和 `docs/TRAE_BACKLOG.md`。
